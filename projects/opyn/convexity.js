...
const factoriesAddresses = ["0xb529964F86fbf99a6aA67f72a27e59fA3fa4FEaC", "0xcC5d905b9c2c8C9329Eb4e25dc086369D6C7777C"];
  ...
  for (let i = 0; i < factoriesAddresses.length; i++) {
    ...
    _.each(optionsCollateral, async (collateralAsset) => {
      ...
      if (
        ...
        collateralAsset.output.toLowerCase() !== "0x0000000000000000000000000000000000000000" &&
        supportedTokens.includes(collateralAsset.output.toLowerCase()) &&
        !optionsCollateralAddresses.includes(collateralAsset.output.toLowerCase())
      ) {
        optionsCollateralAddresses = [...optionsCollateralAddresses, collateralAsset.output.toLowerCase()];
      }
    });
