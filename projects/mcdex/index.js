...
async function GenerateCallList() {
  ...
  _.forEach(marketStatus, (status) => {
    ...
    if (
      ...
      status.perpetualStorage.collateralTokenAddress !== "0x0000000000000000000000000000000000000000"
    ) {
...
async function tvl(timestamp, block) {
  const ethBalance = (await sdk.api.eth.getBalance({ target: "0x220a9f0DD581cbc58fcFb907De0454cBF3777f76", block }))
    .output;
  let balances = {
