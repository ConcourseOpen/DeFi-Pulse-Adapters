...
const escrows = ["0x802275979B020F0ec871c5eC1db6e412b72fF20b", "0xaf38668f4719ecf9452dc0300be3f6c83cbf3721"];
...
async function rates(timestamp, block) {
  // realtime only
  let reserves = (await axios.get("https://api.nuoscan.io/overview?primary_currency_short_name=USD")).data.data
    .reserves;
